...
RETURNING id, name, description, printer_id, is_deleted, created_at, updated_at
`
...
SELECT 
    c.id, c.name, c.description, c.printer_id, c.is_deleted, c.created_at, c.updated_at,

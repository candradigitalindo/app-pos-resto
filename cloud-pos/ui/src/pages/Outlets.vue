            ...
            <template v-else-if="filteredOutlets.length">
              <tr v-for="row in filteredOutlets" :key="row.id" class="tr-data">
                ...
                <td class="td-actions">
                  ...
                  <button
                    :class="['btn-toggle', row.is_active ? 'btn-toggle--off' : 'btn-toggle--on']"
...
.btn-delete {
  ...
  cursor: pointer; border: 1px solid rgba(239,68,68,.25); transition: all .15s;
  background: rgba(239,68,68,.06); color: #dc2626;
}
.btn-delete:hover { background: rgba(239,68,68,.14); border-color: rgba(239,68,68,.4); }
...
.btn-detail {
  ...
  padding: .3rem .7rem; border-radius: .55rem; background: rgba(45,143,86,.1); color: #2d8f56;
  font-size: .73rem; font-weight: 600; text-decoration: none; transition: background .14s; white-space: nowrap;
}
.btn-detail:hover { background: rgba(45,143,86,.18); }
.btn-toggle {
  display: inline-flex; align-items: center; gap: .25rem;
  padding: .3rem .7rem; border-radius: .55rem; font-size: .73rem; font-weight: 600;
  cursor: pointer; border: none; transition: background .14s; white-space: nowrap;
}
.btn-toggle:disabled { opacity: .5; cursor: not-allowed; }
.btn-toggle--off { background: rgba(220,38,38,.08); color: #dc2626; }
.btn-toggle--off:not(:disabled):hover { background: rgba(220,38,38,.15); }
.btn-toggle--on  { background: rgba(22,163,74,.1);  color: #16a34a; }
.btn-toggle--on:not(:disabled):hover  { background: rgba(22,163,74,.18); }

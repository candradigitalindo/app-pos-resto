    ...
    <AppModal v-model="showDetail" title="Detail Pengajuan Barang" size="2xl">
      ...
      <template #footer>
        <div v-if="!parentDetailId" class="flex items-center gap-2 mr-auto">
          ...
          <AppButton v-if="detail && detail.status === 'paid' && authStore.hasPermission('procurement.submit')" variant="primary" @click="confirmDetailAction('receive')">Serah Terima</AppButton>

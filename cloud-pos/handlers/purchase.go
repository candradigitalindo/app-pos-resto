...
func UpdatePurchaseStatus(c *fiber.Ctx) error {
	...
	case "request_payment":
		requiredPerm = "procurement.purchasing"
	case "pay":
		requiredPerm = "procurement.finance"
	case "receive", "cancel":
		requiredPerm = "procurement.submit"
	default:
		return c.Status(fiber.StatusBadRequest).JSON(models.APIResponse{
...
func UpdatePurchaseItems(c *fiber.Ctx) error {
	...
	case "pending":
		requiredPerm = "procurement.submit" // pengaju edits qty
	case "approved":
		requiredPerm = "procurement.purchasing" // purchasing fills prices
	default:
		return c.Status(fiber.StatusBadRequest).JSON(models.APIResponse{
